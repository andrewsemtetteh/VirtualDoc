...
export default function PatientSidebar() {
  ...
  const navigation = [
    { name: 'Home', href: '/dashboard/patient', icon: HomeIcon },
    { name: 'Appointments', href: '/dashboard/patient/appointments', icon: CalendarIcon },
    { name: 'Video Consultation', href: '/dashboard/patient/video-consultation', icon: VideoCameraIcon },
    { name: 'Medical Records', href: '/dashboard/patient/medical-records', icon: DocumentTextIcon },
    { name: 'E-Prescriptions', href: '/dashboard/patient/prescriptions', icon: DocumentArrowDownIcon },
  ];
    ...
    <>
      ...
      <div className="fixed top-0 left-0 z-50 md:hidden">
        <button
          ...
          className="p-4.5 text-gray-600 hover:text-gray-900"
        >
          {isMobileMenuOpen ? (
